...
test('consumer-facing entrypoint exports the core operations', () => {
  ...
  assert.equal(typeof signal.hashVaultMandate, 'function')
  assert.equal(typeof signal.validateVaultMandate, 'function')
  assert.equal(typeof signal.canonicalRunFingerprint, 'function')
